...
assert_contains "$sitemap_xml" '<urlset xmlns="http://www\.sitemaps\.org/schemas/sitemap/0\.9" xmlns:xhtml="http://www\.w3\.org/1999/xhtml">' 'XML sitemap urlset with xhtml namespace'
...
assert_contains "$home_html" '<link rel="alternate" hreflang="en" href="[^"]+"' 'head hreflang alternate (en)'
assert_contains "$home_html" '<link rel="alternate" hreflang="ru" href="[^"]+"' 'head hreflang alternate (ru)'
assert_contains "$home_html" '<link rel="alternate" hreflang="fr" href="[^"]+"' 'head hreflang alternate (fr)'
