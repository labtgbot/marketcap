...
function tonbankcard_content_security_policy() {
    $directives = [
        ...
        "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://telegram.org https://cdn.jsdelivr.net https://unpkg.com https://changenow.io https://mc.yandex.ru",
        "style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://fonts.googleapis.com",
        "font-src 'self' data: https://cdn.jsdelivr.net https://fonts.gstatic.com",
        "img-src 'self' data: blob: https://assets.coingecko.com https://*.coingecko.com https://changenow.io https://*.changenow.io https://mc.yandex.ru",
        "connect-src 'self' https://cdn.jsdelivr.net https://api.coingecko.com https://pro-api.coingecko.com https://api.groq.com https://*.upstash.io https://tonapi.io https://*.tonapi.io https://*.tonkeeper.com https://mc.yandex.ru",
